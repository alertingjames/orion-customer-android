...
public class CheckoutItemListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        holder.quantityBox.setTypeface(normal);
        ...
        holder.picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Commons.checkoutItemsActivity != null){
                    Commons.checkoutItemsActivity.productInfo(String.valueOf(entity.getProduct_id()));
                }else {
    ...
    class CustomHolder {
        ...
        ImageView picture;
        TextView price, oldPrice, productNameBox, storeNameBox, deliveryBox, quantityBox;
